        ...
        <div className="space-y-6">
          ...
          <div className="card">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-end gap-3 mb-4 flex-wrap">
              ...
              <button onClick={scanDuplicates} disabled={dupeScanning} className="btn-primary text-sm inline-flex items-center gap-2">
                {dupeScanning && (
            ...
            {dupeScanning && (
              <div className="flex items-center gap-3 px-4 py-3 rounded-lg border border-blue-200 bg-blue-50 text-blue-700 text-sm">
                <svg className="animate-spin h-5 w-5 flex-shrink-0" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
                  <circle className="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" strokeWidth="4" />
                  <path className="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4z" />
                </svg>
                <span>Scanning accounts for duplicates — comparing names, phone numbers, cities, and contacts. This may take a minute...</span>
              </div>
            )}
            {!dupeScanning && dupeScanResult && (
